...
import {addColArr, addToColArr, addToColDict, fillMeanHue, getAverageRGB} from "../Effects/MeanHue";
import {fillLinearGradient, fillRadialGradient} from "../Effects/RadialGradient";
...
export function completeTile(currTile, invisCol) {
    if (completeTileOn) {
        ...
        else if(fillType === "radialGradient") fillRadialGradient(currTile)
        else if(fillType === "diagGradient") fillLinearGradient(currTile,)
