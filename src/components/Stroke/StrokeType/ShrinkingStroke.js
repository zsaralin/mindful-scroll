...
export function createShrinkingStroke(x1, y1, x2, y2, size) {
    ...
    if(size === "small" )
        endWidth = theLineWidth > LINE_WIDTH - 15 ? theLineWidth - 4: theLineWidth > 5 ? theLineWidth - 1: theLineWidth;
    else if(size === "big") endWidth = theLineWidth < LINE_WIDTH + 15 ? theLineWidth + .1 : theLineWidth
